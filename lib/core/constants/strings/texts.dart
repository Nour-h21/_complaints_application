class AppTexts {
  ...
  static String welcomeb = 'أهلاً بعودتك !';
  static String please = 'Please Enter your email and Password';
  ...
  static String haveAccount = ' لديك حساب ؟';
  static String nosignup = 'سجل دخولك';
  static String nologin = 'سجل الآن';
